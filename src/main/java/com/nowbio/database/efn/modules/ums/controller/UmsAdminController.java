package com.nowbio.database.efn.modules.ums.controller;
...
import com.nowbio.database.efn.modules.ums.dto.UmsAdminLoginParam;
...
public class UmsAdminController {
    ...
    @ResponseBody
    public CommonResult<UmsAdmin> register(@RequestBody @Validated AdminRegisterParam umsAdminParam) {
    ...
    public CommonResult login(@Valid @RequestBody UmsAdminLoginParam umsAdminLoginParam, BindingResult result) {
        LOGGER.warn("请求参数:{}", umsAdminLoginParam.getUsername()+umsAdminLoginParam.getPassword());
        String token = adminService.login(umsAdminLoginParam.getUsername(), umsAdminLoginParam.getPassword());
        if (token == null) {
            return CommonResult.validateFailed("用户名或密码错误1");
        }
